...
const PARENT_NAME = "Equipment"; // must match DB parent category name
            ...
            <section className="bg-[#24272b] px-5 py-14 text-white sm:px-8 lg:px-12">
                <div className="mx-auto max-w-[1440px]">
                    ...
                    <p className="mt-3 max-w-2xl text-sm text-gray-300 sm:text-base">
                        Browse excavators, bulldozers, loaders, trucks and other industrial
                        machinery listed by verified sellers.
                    </p>
                </div>
            </section>
